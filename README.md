...
A plugin to manage LuQY Pro measurement data
...
```sh
git clone https://github.com/Pepe-Marquez/nomad-luqy-plugin.git
cd foobar
...
| Name | E-mail     |
|------|------------|
| Pepe Márquez | [pepemarquezprieto@gmail.com](mailto:pepemarquezprieto@gmail.com)
